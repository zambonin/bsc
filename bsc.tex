...
Standards and Technology}) do algoritmo
Rjindael. Seu funcionamento é denominado
...
que faça o inverso do procedimento acima~\cite{Daemen:2002:DR:560131}. Assim,
suas etapas precisam ser modificadas de acordo.
...
\begin{algorithm}[H]
  ...
  \For{$i \leftarrow n_r - 1$ \KwTo $1$}{
    ...
    $\longleftarrow \textsc{AddRoundKey}(A,
      \{K^{e}_{i \cdot \ell}, \dots, K^{e}_{(i + 1) \cdot \ell - 1}\})$\;
