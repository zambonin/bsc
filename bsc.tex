...
\begin{figure}
    \centering
    \begin{tikzpicture}
    \begin{axis}[xtick align=inside, ymin=0,
        scaled x ticks=false, ticklabel style={font=\tiny},
        xlabel near ticks, ylabel near ticks,
        ylabel=Probabilities, xlabel=$\mu(\mathcal{B}_{r,1})$]
    ...
    \begin{axis}[ticks=none, ymin=0,
        ...
        \addplot [dashed,thick]
            ...
            \legend{$\mu' \approx 32774$ \\ $\sigma \approx 4738$}
    \end{axis}
\end{tikzpicture}
    \caption{Caption}
    \label{fig:12}
