...
O esquema descrito tem estrutura similar à variante em processo de padronização pela IETF~\cite{irtf-cfrg-xmss-hash-based-signatures-12}, que faz uso de \textsc{Wots+} e
