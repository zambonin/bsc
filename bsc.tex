...
Evidentemente, as otimizações propostas nos esquemas \textsc{Wots-b} e \textsc{Wots-r} podem ser aplicadas a quaisquer variantes da família Winternitz. Consequentemente, qualquer esquema baseados em árvores de Merkle pode fazer uso de instâncias otimizadas destes esquemas em suas folhas. A fim de demonstrar esta afirmação, a implementação\footnote{\url{https://github.com/zambonin/xmss-reference}} de \wotsplus{}, esquema de assinatura única escolhido para o esquema \xmss{} definido em~\cite{irtf-cfrg-xmss-hash-based-signatures-12}, é modificada de acordo.
