...
$T$ inteiramente. Considere uma subrotina $\textsc{Leaf}(k), 0 \leq k \leq 2^{H} - 1$,
que calculare

O algoritmo \textsc{Treehash}, munido de uma pilha
\textbf{S} usual com as operações $\mathbf{S}.pop()$ e $\mathbf{S}.push(\cdot)$,
calcula o nodo desejado em
