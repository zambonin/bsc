...
\begin{figure}
  \begin{minipage}[t]{.5\linewidth}
    \centering
    % TODO do not import this
    \includegraphics[scale=0.65]{support/hist}
  \end{minipage}%
  \begin{minipage}[t]{.5\linewidth}
    \centering
    \begin{tikzpicture}[scale=0.65]
      \begin{axis}[
          axis lines = left, xlabel = $R$,
...
\begin{figure}
  ...
  \begin{tikzpicture}[
      every axis/.style={
        ...
        ylabel=Redução do \textnumero{} de iterações de $f$,
        yticklabel={\pgfmathparse{\tick}\pgfmathprintnumber{\pgfmathresult}\%},
        scale = 0.75, legend pos = north west
      },
    ]
  ...
  \begin{tikzpicture}[
      every axis/.style={
        title=$\argmin$,
        ybar stacked, x=2cm, enlarge x limits=0.25, bar width=8pt, xtick=data,
        symbolic x coords={4, 8, 16}, ymin=0, ymax=55, yticklabels={,,},
        try min ticks = 5, xtick style={draw=none}, xlabel = $w$, scale=0.75,
        legend pos = north west
      },
    ]
    \begin{axis}[bar shift=-10pt,hide axis]
      \addplot+[black, fill=white, postaction={pattern=north west lines}]
