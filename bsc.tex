...
com uma chave de rodaa.

Note que existe uma rodada adicional introdutória composta apenas de
\textsc{AddRoundKey}, para que o estado inicial seja modificado. Isto é
fundamentado pelo construção abstrada chamada de rede de substituição-permutação, na qual o
AES é baseado. Ademais, \textsc{MixColumns} é ignorado na última rodada,
a fim de facilitar a reversibilidade da cifra. Estes componentes serão descritos
abaixo.
