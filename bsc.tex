...
\binom{t}{k} \geq 2^m, t \gg k$, e adicionalmente $t$ sendo uma potência de 2. O tamanho dos pares de chaves e das assinaturas
...
\begin{enumerate}
  ...
  \item[] \emph{Geração da assinatura.} Tome uma mensagem $M$, calcule o seu
    ...
    ou seja, $\mathbf{d} = (d_0, \dots, d_k)$. Interpretando cada
