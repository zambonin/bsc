...
\usepackage{amsmath, amsfonts, booktabs, chronology, enumitem, multirow, parskip, tikz, tikz-qtree, xfrac, pgfplots}
...
\begin{align}
    ...
    \end{split}
\end{align}
Então, para garantir que estes eventos aconteçam com altíssima probabilidade, utiliza-se a distribuição binomial a fim de procurar a quantidade mínima de experimentos em que pelo menos um destes produza o valor desejado. Este comportamento pode ser visualizado na Figura~\ref{fig:13}, com quantidades sugeridas de $\{25, 200, 3500\}$ para parâmetros $w = \{4, 8, 16\}$ recomendados em~\cite{irtf-cfrg-xmss-hash-based-signatures-12}, respectivamente. Note que os valores para as probabilidades acima podem ser modificados a fim de produzir tuplas $\mathcal{B}_{i}^{1}$ cujas médias são maiores, entretanto, $R$ crescerá de modo diretamente proporcional.
...
\begin{table}[htbp]
    ...
    \toprule
    \multirow{24}{*}{\rotatebox[origin=c]{90}{$\argmax (\mathcal{V})$}} & \multirow{8}{*}{4} & \multirow{2}{*}{-}
       &    \textsc{Wots} &     \multirow{2}{*}{479.93} &      25.88 &     505.80 \\
     && &  \textsc{Wots-b} &      &      12.25 &     492.18 \\ \cline{3-7}
    && \multirow{2}{*}{25}
       &  \textsc{Wots-r} &     \multirow{2}{*}{407.81} &      27.49 &     435.29 \\
     && & \textsc{Wots-br} &      &      13.49 &     421.29 \\ \cline{3-7}
    & &\multirow{2}{*}{200}
       &  \textsc{Wots-r} &     \multirow{2}{*}{379.08} &      29.23 &     408.31 \\
     && & \textsc{Wots-br} &      &      15.23 &     394.31 \\ \cline{3-7}
    && \multirow{2}{*}{3500}
       &  \textsc{Wots-r} &     \multirow{2}{*}{348.88} &      31.14 &     380.02 \\
    & & & \textsc{Wots-br} &      &      17.14 &     366.02 \\ \cline{2-7}
    &\multirow{8}{*}{8} & \multirow{2}{*}{-}
       &    \textsc{Wots} &    \multirow{2}{*}{4081.84} &     368.43 &    4450.27 \\
     && &  \textsc{Wots-b} &      &     136.25 &    4218.08 \\ \cline{3-7}
    && \multirow{2}{*}{25}
       &  \textsc{Wots-r} &    \multirow{2}{*}{3262.39} &     370.56 &    3632.95 \\
     & && \textsc{Wots-br} &      &     130.56 &    3392.95 \\ \cline{3-7}
    & &\multirow{2}{*}{200}
       &  \textsc{Wots-r} &    \multirow{2}{*}{2940.63} &     372.13 &    3312.76 \\
     && & \textsc{Wots-br} &      &     132.13 &    3072.76 \\ \cline{3-7}
    && \multirow{2}{*}{3500}
       &  \textsc{Wots-r} &    \multirow{2}{*}{2604.49} &     374.75 &    2979.24 \\
     & && \textsc{Wots-br} &      &     134.75 &    2739.24 \\ \cline{2-7}
    &\multirow{8}{*}{16} & \multirow{2}{*}{-}
      &    \textsc{Wots} &  \multirow{2}{*}{525120.63} &   98231.81 &  623352.44 \\
     && &  \textsc{Wots-b} &      &   32707.82 &  557828.45 \\ \cline{3-7}
    && \multirow{2}{*}{25}
      &  \textsc{Wots-r} &  \multirow{2}{*}{376550.24} &   98225.54 &  474775.78 \\
     && & \textsc{Wots-br} &      &   32697.52 &  409247.76 \\ \cline{3-7}
    & &\multirow{2}{*}{200}
       &  \textsc{Wots-r} &  \multirow{2}{*}{319490.02} &   98850.06 &  418340.08 \\
     & && \textsc{Wots-br} &      &   33321.91 &  352811.94 \\ \cline{3-7}
    & &\multirow{2}{*}{3500}
       &  \textsc{Wots-r} &  \multirow{2}{*}{262301.92} &  101022.36 &  363324.28 \\
     & && \textsc{Wots-br} &      &   35492.57 &  297794.48 \\ \hline \hline
    \multirow{12}{*}{\rotatebox[origin=c]{90}{$\argmin (\mathcal{S})$}} & \multirow{4}{*}{4} & -
       &    \textsc{Wots} &     479.93 &      25.88 &     505.80 \\
    && 25
       &  \multirow{3}{*}{\textsc{Wots-r}} &     407.81 &      27.49 &     435.29 \\
    && 200
       &  &     379.08 &      29.23 &     408.31 \\
    && 3500
       &  &     348.88 &      31.14 &     380.02 \\ \cline{2-7}
    &\multirow{4}{*}{8} & -
       &    \textsc{Wots} &    4081.84 &     368.43 &    4450.27 \\
    && 25
       &  \multirow{3}{*}{\textsc{Wots-r}} &    3262.39 &     370.56 &    3632.95 \\
    && 200
       &  &    2940.63 &     372.13 &    3312.76 \\
    && 3500
       &  &    2604.49 &     374.75 &    2979.24 \\ \cline{2-7}
    &\multirow{4}{*}{16} & -
       &    \textsc{Wots} &  525120.63 &   98231.81 &  623352.44 \\
    && 25
       &  \multirow{3}{*}{\textsc{Wots-r}} &  376550.24 &   98225.54 &  474775.78 \\
    && 200
       &  &  319490.02 &   98850.06 &  418340.08 \\
    && 3500
       &  &  262301.92 &  101022.36 &  363324.28 \\
    \bottomrule
    \end{tabular}
    \label{tab:3}
    \caption{Iterações de $f$ na etapa de geração de assinaturas ao modificar $\mathcal{B}_1$.}
\end{table}
