...
\todo[inline]{comentario legal sobre como no lamport escolhe-se entre 2m valores, no winternitz entre 2^w - 1 x t, e no hors k valores entre t, ai depois existem iteraçoes de uma f que é geralmente nao inversivel}
