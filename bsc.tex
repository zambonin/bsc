...
A redução dos requisitos de segurança para resistência à segunda pré-imagem de funções de resumo criptográfico, bem como a presença do sigilo encaminhado e gerenciamento de estado, são as principais características do esquema XMSS, apresentado em~\cite{Buchmann:2011:XPF:2184003.2184011} como uma forma mais eficiente de aplicar as ideias impostas no esquema SPR-MSS.
