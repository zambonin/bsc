...
\begin{align}
    ...
    \end{split}
\end{align}
Então, para assegurar que estes eventos aconteçam com altíssima probabilidade, i.e. 99.9\%, é possível observar a função distribuição e derivar o número de experimentos desejado. Desse modo, a Figura~\ref{fig:13} provê a visualização necessária.
