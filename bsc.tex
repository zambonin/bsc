...
\begin{align}
    ...
    \end{split}
\end{align}
Então, para assegurar que estes eventos aconteçam com altíssima probabilidade, i.e. aproximadamente 99\%, utiliza-se a distribuição binomial a fim de procurar a quantidade mínima de experimentos em que pelo menos um destes produza o valor desejado. Este comportamento pode ser visualizado na Figura~\ref{fig:13}. Os valores sugeridos são $\{25, 200, 3500\}$.
