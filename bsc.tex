...
do resumo por completo e subseções deste.

Adicionalmente, discute-se brevemente a relação da propriedade (iv) com
funções de resumo. Ao parametrizar uma
...
Note que \textsc{Sec} e \textsc{Col} apresentam uma sutil diferença: na
