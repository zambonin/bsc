...
possibilita a busca de elementos em conjuntos em tempo sub-linear.
Por outra forma, suponha que deseja-se inverter uma função $f$ desconhecida.
Para tal, é necessário buscar o elemento no domínio de $f$ 

uma função genérica que age sobre qualquer
elemento de seu domínio.
