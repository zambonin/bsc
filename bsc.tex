...
\begin{table}[htbp]
    ...
    \toprule
    \multirow{24}{*}{\rotatebox[origin=c]{90}{$\argmax, V$}} & \multirow{8}{*}{4} & \multirow{2}{*}{-}
    ...
    \multirow{12}{*}{\rotatebox[origin=c]{90}{$\argmin, S$}} & \multirow{4}{*}{4} & -
    ...
    \end{tabular}
    \label{tab:2}
    \caption{Variação do número de iterações de $f$ nos esquemas \textsc{Wots-b}, \textsc{Wots-r}  .}
\end{table}
