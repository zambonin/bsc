...
Para o esquema \textsc{Wots-b}, é possível perceber uma redução de aproximadamente $2^w$ iterações de $f$, condizente com o número de \emph{bits} inutilizados apresentados na Tabela~\ref{tab:1}. No caso de \textsc{Wots-r}, observam-se reduções de até 
