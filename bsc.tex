...
segurança se implementada de maneira ingênua. Observe, por exemplo, que não
existe qualquer fator aleatório na codificação da mensagem, caracterizando-a
como determinística e portanto tornando o sistema semanticamente inseguro.


É desejável que uma mensagem cifrada qualquer não revele informações sobre seu
texto plano correspondente

. Desse modo, esta
etapa é caracterizada como determinística, habilitando uma entidade
...
baseado em semelhanças entre as mensagens cifradas. Um sistema que impede
este comportamento é chamado de semanticamente seguro, ou seja, uma mensagem
cifrada não revela informações sobre seu texto plano correspondente.
...
% write a few more about digital signatures
% write about xmss and rfc variants
