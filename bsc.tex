...
\end{split}
\end{align}
Isto ocorre pois um número inteiro de palavras em base-$w$ são utilizadas para acomodar $c$. Portanto, é possível definir o número de \emph{bits} inutilizados como o número natural $n_u = t_2w - n_c$. Para os valores mais comuns de $w$ e $m$, a Tabela~\ref{tab:1} apresenta várias combinações de parâmetros para esquemas da família Winternitz. 
...
\begin{table}[htbp]
    ...
    \multirow{4}{*}{4}  &  128  &  9   &  3   &  \multirow{4}{*}{12} \\
                        ...
                        &  512  &  11  &  1   &                      \\
    \midrule      
    \multirow{4}{*}{5}  &  128  &  10   &  3   &  \multirow{4}{*}{12} \\
                        &  192  &  11  &  2   &                      \\
                        &  256  &  11  &  2   &                      \\
                        &  512  &  12  &  1   &                      \\
    \midrule      
