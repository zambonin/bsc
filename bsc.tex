...
A redução dos requisitos de segurança para resistência à segunda pré-imagem de funções de resumo criptográfico, bem como a presença do sigilo encaminhado, são as principais características do esquema XMSS. Estes recursos foram agrupados e apresentados em 

Apresentado em~\cite{Buchmann:2011:XPF:2184003.2184011} como uma forma mais eficiente de aplicar as ideias impostas em SPR-MSS, a utilização de um gerador de números pseudoaleatórios diferenciado provê a chaves antigas
