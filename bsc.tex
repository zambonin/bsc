...
\begin{table}[htbp]
    ...
    \toprule
    \multirow{24}{*}{\rotatebox[origin=c]{90}{$max(S)$}} & \multirow{8}{*}{4} & \multirow{2}{*}{-}
       &    \textsc{Wots} &     \multirow{2}{*}{479.93} &      25.88 &     505.80 \\
     && &  \textsc{Wots-b} &      &      12.25 &     492.18 \\ \cline{2-7}
    && \multirow{2}{*}{25}
    ...
    & \multirow{2}{*}{3500}
     ...
     & && \textsc{Wots-br} &      &   35492.57 &  297794.48 \\ \hline
    \multirow{12}{*}{\rotatebox[origin=c]{90}{$min(S)$}} & \multirow{4}{*}{4} & -
