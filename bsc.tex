...
\end{tikzpicture}
\caption{Considere $\mathcal{D}_n, n \in \mathbb{N}$ como qualquer informação ou mensagem desejada. Uma árvore de Merkle pode ser construída recursivamente a partir da concatenação dos resumos dos dados contidos nos filhos de um nó. Acima, uma representação gráfica de uma árvore com quatro folhas.}
\label{fig:4}
\end{figure}
