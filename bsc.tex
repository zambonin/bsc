...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \draw[-latex] (x5) -- (s5);
    \end{tikzpicture}
    \caption{Representação gráfica do mapeamento de valores do resumo $d$ para valores de $\sk{}$, resultando na criação da assinatura $\sigma$, para $0 \leq i \leq k - 1, \; 0 \leq j, l \leq t - 1$, no HORS.}
    \label{fig:7}
\end{figure}
