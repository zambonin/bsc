...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \node[draw, minimum width=3em, minimum height=1.75em, right = 2pt of d1] (d2) {$d_{j - 1}$};
        \node[draw, minimum width=3em, minimum height=1.75em, right = 7.5pt of d2] (d3) {$d_{j}$};
        ...
        \node[draw,dashed,minimum width=23em,minimum height=2.5em] (dbox) at (3.5, -3) {};
        \node[draw, minimum width=3em, minimum height=1.75em] (x0) at (-0.3, -) {$x_0$};        \node[minimum width=1.5em, minimum height=1.75em, right = 2pt of x0] (x1) {$\dots$};
        \node[draw, minimum width=3em, minimum height=1.75em, right = 2pt of x1] (x2) {$x_{i}$};
        ...
        \node[draw, minimum width=3em, minimum height=1.75em, right = 2pt of x4] (x5) {$x_{j}$};
...
\todo[inline]{just a few more? maybe a drawing? HORST?}
