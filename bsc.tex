...
Um esquema baseado em árvores de Merkle que necessita apenas de resistência à segunda pré-imagem em todos os seus componentes é proposto em~\cite{Dahmen:2008:DSO:1473109.1473117}. Consiste na reestruturação das folhas, onde o resumo da concatenação dos elementos de cada chave pública não é mais calculado. De forma diferenciada, estes elementos são reorganizados em uma árvore possivelmente desbalanceada. Adicionalmente, estes elementos são somados à máscaras de \emph{bits} aleatórias, também aplicadas em cada criação de nodo na árvore de Merkle.

adicionadas a cada criação de nodo na árvore de Merkle, e às árvores localizadas nas folhas.
