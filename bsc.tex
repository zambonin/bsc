...
De acordo com a seção do \wots{}, considere a $t_1$-tupla $\mathcal{B}_1$ como os valores do resumo da mensagem divididos em palavras de base-$w$ e a soma de verificação $c = \sum_{b \in \mathcal{B}_1} 2^w - 1 - b$.
