...
padronizados e implementados em diversas formas de comunicação segura. Também são
apresentados a função de resumo criptográfico, utilizada para que o processo de assinatura
