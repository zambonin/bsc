...
\begin{enumerate}[label=(\roman*)]
    ...
    \item \hh{} pode apresentar \emph{resistência à colisões} (\textsc{Col}),
        caracterizada pelo seguinte comportamento: para quaisquer duas mensagens $m_0, \; m_1 \in X$ e $m_0 \neq m_1$, é computacionalmente inviável
        encontrar $\hash{m_0} = \hash{m_1}$. \hh{} é considerada resistente à colisões
\end{enumerate}
