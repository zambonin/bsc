...
A partir destes, calcula-se
    ...
    t = t_1 + t_2,$$
que representarão, respectivamente, a quantidade de palavras de tamanho $m$ na assinatura referente à mensagem, à soma de verificação, e a adição destes valores.
