...
\begin{enumerate}
  ...
  não utilizado anteriormente, calcula-se $\textsc{Ots}_\sigma^{j} = \textsc{Ots}_\mathcal{S}(d)$. O caminho de autenticação \textsc{Auth} é construído com o auxílio de algoritmos de rav
