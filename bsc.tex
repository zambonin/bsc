...
\begin{enumerate}
    ...
    a_{h} &= 
    \begin{cases}
    \hash{a_{h - 1} \concat \textsc{Auth}_{h - 1}}, \text{ se } \lfloor \sfrac{s}{2^{h-1}} \rfloor \equiv 1 \pmod{2} \\
    \hash{p_{h - 1} \concat \textsc{Auth}_{h - 1}}, \text{ se } \lfloor \sfrac{s}{2^{h-1}} \rfloor \equiv 0 \pmod{2} \\
    \end{cases}
    \end{split}
    \end{equation}
