...
convencionais baseados em árvores de Merkle, como o homônimo, bem como
os esquemas Merkle, XMSS (\emph{eXtended Merkle Signature Scheme}) e sua variante
multiárvores XMSS$^{MT}$, SPHINCS e SPHINCS+, e a relação entre estes. Em especial, estes
