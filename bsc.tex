...
inseguro. Este e outros ataques~\cite{} são mitigados com a aplicação de uma
função de preenchimento à mensagem~\cite{}.

Outros ataques podem ser aplicados se uma função de preenchimento
