...
\begin{figure}[ht]
    \centering
    \begin{tikzpicture}
        \node[draw,circle,minimum size=2cm] (left) at (0.5, -2) {$T_{h - 1, 2j}$};
        \node[draw,circle,minimum size=2cm] (right) at (3.5, -2) {$T_{h - 1, 2j + 1}$};
        ...
        \node[draw,minimum size=0.75] (hash) at (2, 1.75) {$\hh{}$};
