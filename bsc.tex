...
\todo[inline]{second pre-image resistance \\
finish talking about how collision resistance can be ignored, alluding to xmss}

\todo[inline]{where should i write things about cmss, gmss etc?}

\subsection{XMSS -- \emph{eXtended Merkle Signature Scheme}}

\todo[inline]{spr-mss, goldreich}
