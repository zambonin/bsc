...
\begin{figure}
    ...
    \node[name=closed, below of=dangling] {$\times$};
    \node[name=virtual, below of=future, draw, dashed, circle] {$\dots$};
    ...
    \draw[dashed] (dangling) to (closed);
    \draw[dashed] (future) to (virtual);
    \end{tikzpicture}
