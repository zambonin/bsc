...
Para demonstrar a eficiência teórica dos esquemas propostos, o número de iterações da função interna $f$ é comparado entre \wots{}, \textsc{Wots-b}, \textsc{Wots-r} e o esquema \textsc{Wots-br}, onde as duas otimizações são aplicadas ao mesmo tempo. Valores de $w$ são escolhidos de acordo com a recomendação de~\cite{irtf-cfrg-xmss-hash-based-signatures-12},.
