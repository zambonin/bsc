...
esquema HORS (\emph{hash to obtain random subset}). Neste caso, a função $f$ é
modificada

o conteúdo da
mensagem controla a seleção de elementos em uma lista de inteiros trivial,
construindo subconjuntos variados.
