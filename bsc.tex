...
A redução dos requisitos de segurança para resistência à segunda pré-imagem de funções de resumo criptográfico, bem como a presença do sigilo encaminhado e gerenciamento de estado, são características 

para um esquema baseado em árvores de Merkle, além da presença do sigilo encaminhado e do gerenciamento de estado
