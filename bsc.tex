...
\end{tikzpicture}
\caption{Considere $\mathcal{D}_n$ como qualquer informação ou mensagem desejada. Uma árvore de Merkle pode ser construída recursivamente a partir da concatenação dos resumos dos dados contidos nos filhos de um dado nó.}

ake $\mathcal{D}_n$ as any data block. A Merkle tree
