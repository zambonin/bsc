...
Geralmente, cifras de bloco (DES, AES) ou de fluxo (RC4, Salsa20),
construídas a partir de operações binárias e matemáticas, favoráveis
para computadores e portanto de extremo alto desempenho, são a base
destes algoritmos. Utilizando estas como alicerce, é possível construir funções de resumo criptográfico (a serem
