...
Algoritmos de travessia mostram-se essenciais no funcionamento prático de esquemas com hiper-árvores, visto que estas estruturas existirão apenas parcialmente em qualquer dispositivo de armazenamento, embora nodos em várias partes de toda a árvore são necessários para construir caminhos de autenticação. 
Naturalmente, este recurso é aplicado ao esquema XMSS a fim de produzir a variante XMSS+, e posteriormente, a versão generalizada XMSS$^{MT}$, abordada abaixo. 
