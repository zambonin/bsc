...
\begin{figure}
      ...
      \caption{Outline of the most important moments in hash-based digital signature schemes research, starting in 1979 with Lamport's one-time scheme, and shortly after with the work of Merkle, allowing many-time schemes through the use of hash trees. \vspace{2mm} 
