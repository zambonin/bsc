...
um resumo criptográfico cuja codific
Uma estratégia similar, buscando a melhor interpretação de uma codificação \emph{run-length} do resumo criptográfico, é apresentada.
~\cite{Steinwandt2008},~\cite{mcgrew-hash-sigs-11}
