...
A Tabela~\ref{tab:4} apresenta os resultados obtidos, na forma da média do tempo de execução de $2^{14}$ instâncias dos esquemas \xmss{}, \textsc{Xmss-b}, \textsc{Xmss-r} e \textsc{Xmss-br}, de acordo com a notação fixada nas seções~\ref{section:wotsb} e~\ref{section:wotsr}.
...
\begin{table}[htbp]
    ...
    \toprule
    & $w$ & $R$ & \textsc{Esquema} & Tempo para $\mathcal{S}$ & \textsc{Ver. time} \\
    \toprule
