...
O esquema descrito tem estrutura similar à variante em processo de padronização pela IETF~\cite{irtf-cfrg-xmss-hash-based-signatures-12}, que faz uso de \textsc{Wots+} como instância de esquema de assinatura única. Este esquema também conta com outros arcabouços que permitem a resistência a ataques específicos. Por exemplo, a associação entre 
