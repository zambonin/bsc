...
instâncias almejado. Encontra-se em processo de padronização pela
IETF (\emph{Internet Engineering Task Force}) um esquema que combate este tipo
de ataque, publicado originalmente como uma patente estadunidense em 1995 ---
desta maneira movendo a atenção 
