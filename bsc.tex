...
\begin{abbrv}
    \item[BiBa]                 \emph{Bins and Balls one-time signature scheme}
    ...
    \item[\textsc{Sphincs}]     \emph{Stateless Practical Hash-based Incredibly Nice Cryptographic Signatures}
    \item[\textsc{Spr-Mss}]     \emph{Second Preimage Resistant Merkle Signature Scheme}
...
\begin{enumerate}
    \item Descrever os esquemas de assinatura digital única
\end{enumerate}
Descrever os esquemas de assinatura digital única
