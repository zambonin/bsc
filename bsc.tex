...
Naturalmente, este recurso é aplicado ao esquema XMSS a fim de produzir a variante XMSS+, e posteriormente, a versão generalizada XMSS$^{MT}$, abordada abaixo. Para melhor entendimento deste esquema, o algoritmo
