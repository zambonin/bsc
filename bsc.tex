...
\begin{enumerate}[label=(\roman*)]
    ...
    \item \hh{} pode aceitar um segundo parâmetro, que assemelha-se
        a uma chave, parametrizando o funcionamento desta.
        
\end{enumerate}



Assim, é possível classificá-las de acordo com a presença destas
propriedades. O foco deste trabalho são funções de resumo adicionadas
...
armazenados em um dispositivo inseguro. Mostra-se desejável para funções de resumo
criptográfico que não ocorra uma relação aparente entre entradas
e saídas da função. 
