...
\begin{enumerate}
    ...
    a_{k} &= 
    \begin{cases}
    \hash{a_{k - 1} \concat \textsc{Auth}_{h - k}}, \text{ se } \lfloor \sfrac{j}{2^{k - 1}} \rfloor \equiv 0 \pmod{2} \\
    \hash{\textsc{Auth}_{h - k} \concat a_{k - 1}}, \text{ se } \lfloor \sfrac{j}{2^{k - 1}} \rfloor \equiv 1 \pmod{2} \\
    \end{cases}
    \end{split}
    \end{equation}
