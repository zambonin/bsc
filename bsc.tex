...
\usepackage{amsmath, amsfonts, booktabs, chronology, enumitem, multirow, parskip, pgfplots, tikz, tikz-qtree, xfrac}
...
Considerando a maximização de $\mu(\mathcal{B}_1)$,
Para o esquema \textsc{Wots-b}, é possível perceber uma redução de aproximadamente $2^w$ iterações de $f$, condizente com o número de \emph{bits} inutilizados apresentados na Tabela~\ref{tab:1}. No caso de \textsc{Wots-r}, observam-se reduções de até $25\%$ para $w = 4$, $33\%$ para $w = 8$ e $42\%$ para $w = 16$. Aplicando ambas as otimizações, tem-se o esquema \textsc{Wots-br} com melhorias de até $28\%$, $39\%$ e $52\%$, respectivamente. 

\todo[inline]{discuss numbers here}
