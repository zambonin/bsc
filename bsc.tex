...
\begin{tikzpicture}
    ...
    \node[draw, minimum width=3em, minimum height=1.75em, right = 1pt of d0] (d1) at (1.5, -1) {$\dots$};
    % \node[draw, minimum width=3em, minimum height=1.75em] (d2) at (2.5, -1) {$d_{j -1}$};
    % \node[draw, minimum width=2em] (dd) at (0.5, -1) {$d_0$};
    \draw[-latex] (hm) -- (sig);
\end{tikzpicture}
