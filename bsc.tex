...
Neste capítulo, sáo apresentados os esquemas de assinatura digital única Lamport-Diffie, a fim de fundamentar o raciocínio por trás do esquema alvo, Winternitz e \textsc{Wots+}, bem como os esquemas Merkle, XMSS, XMSS$^{MT}$, SPHINCS e SPHINCS+, e a relação entre estes.
