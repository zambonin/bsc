...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \draw[-latex] (d3) -- (x2);
    \end{tikzpicture}
    \caption{Representação gráfica do mapeamento de valores do resumo $d$ para valores de $\sk{}$, para $0 \leq i \leq k - 1, 0 \leq j, l \leq t - 1$. Note que uma conversão de palavras binárias para inteiros está implícita no diagrama.}
    \label{fig:my_label}
\end{figure}
