...
espalhamento. Por outro lado, uma função de mão única imp
...
© possÃ­vel construir trivialmente algoritmos que respeitam a equaÃ§Ã£o acima, sem
qualquer tipo de codificaÃ§Ã£o a fim de ocultar mensagens.  Na Figura
\ref{fig:2}, Ã© possÃ­vel visualizar um diagrama do comportamento de um esquema
de assinatura digital genÃ©rico. Note que $\sigma$ geralmente Ã© composta da
concatenaÃ§Ã£o da mensagem original com a assinatura do resumo criptogrÃ¡fico
desta, embora a saÃ­da do algoritmo \textsc{Sig} consista apenas da aplicaÃ§Ã£o de
