...
\begin{abbrv}
    ...
    \item[\textsc{Wots}]  \emph{Lamport-Diffie One-time Signature Scheme}
    \item[\textsc{Wots-lm}]  \emph{Lamport-Diffie One-time Signature Scheme}
    \item[\textsc{Wots-prf}]  \emph{Lamport-Diffie One-time Signature Scheme}
    \item[\textsc{Wots+}]  \emph{Lamport-Diffie One-time Signature Scheme}
