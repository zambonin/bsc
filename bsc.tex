...
Assim, é possível utilizar este resultado para fornecer valores razoáveis para $R$. Utilizando a tabela da distribuição normal padrão com desvio padrão $\sigma$,
