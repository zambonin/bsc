...
\path (8.5, -1) node {\bf Absorbing phase};
\path (25, -1) node {\bf Squeezing phase};
...
\begin{scope}[xshift=8cm]
    ...
    \draw[edge,thick] (1,8) -- (xm1);
    \draw[edge,thick] (1,2) -- ++(3,0);  
    \draw[edge,thick] (1+1.5,10.5) node[above] {\large $m_{k}$} -- (xm1);
    \draw[edge,thick] (xm1) -- ++(1.5,0);
\end{scope}
...
\begin{scope}[xshift=20cm]
  ...
  \draw[edge,thick] (1,2) -- ++(3,0);
  \draw[edge,thick] (1,8) -- ++(3,0);  
  \draw[edge,thick] (1+1.5,8) -- ++(0,2.5) node[above] {$\dots$};
\end{scope}
