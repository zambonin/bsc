...
padronizados e implementados em diversas formas de comunicação segura, nas Subseções~\ref{subsection:aes} e~\ref{subsection:rsa}. Funções de resumo criptográfico, utilizadas
...
mais elaborada de autenticação (\emph{i.e.} um valor pseudoaleatório concatenado ao
