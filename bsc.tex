...
\begin{figure}[ht]
  ...
  \begin{chronology}[4]{1978}{1997}{\textwidth}
    ...
    \event[1996]{1994}{}
  \end{chronology}
  \caption{Principais trabalhos acadêmicos sobre esquemas de assinatura digital baseados em funções de resumo criptográfico até 1997.}
  \label{fig:10}
\end{figure}
