...
consiste da geração de duas palavras pseudoaleatórias $x_0, x_1$
e resumos $\hash{x_0}, \hash{x_1}$ para cada \emph{bit} $b$ de informação. Distribui-se todos os resumos 
