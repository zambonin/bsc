...
mas não necessariamente este tipo de função precisa comprimir dados. Uma
função de resumo de mão única é obtida com as cinco primeiras propriedades.
Por fim, uma função de resumo resistente à colisões,
ou \emph{função de resumo criptográfico}, conta com as seis
