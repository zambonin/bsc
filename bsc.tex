...
RSA~\cite{Rivest:1978:MOD:359340.359342}\sigla{RSA}{\emph{Rivest---Shamir---Adleman}}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \end{scope}
    \draw[black!50, thick] (0, 0) circle (1.25cm) node {\textsc{Pre}};
    \draw[black!50, thick] (1.75, 0) circle (1.25cm) node {};
    \draw[black!50, thick] (1.75, 0) circle (0.75cm) node {\textsc{Col}};
...
e~\ref{subsection:wotsplus}. Adicionalmente, o esquema de
...
\begin{figure}
  ...
  \begin{tikzpicture}[scale=0.25]
    ...
    \node[XOR] (x0) at (7, 2) {};
    \draw[->] (-4, 2) node[left] {$x_{i}$} -- ++(4, 0);
    \draw[->] (4, 2) -- (x0);
    \draw[->] (x0) -- ++(3, 0) node[right] {$h_{i}$};
    \draw[->] (-2, 2) -- ++(0, -3) -- ++(9, 0) -- (x0);
    \draw[->] (-4, 6) node[left] {$h_{i-1}$} -- ++(2, 0);
    \draw[->] (0, 6) -- ++(2, 0) -- ++(0, -2);
  \end{tikzpicture}
...
\begin{figure}
  \centering
    \begin{tikzpicture}[
        ...
        level distance=45pt, sibling distance=25pt
    ]
    \Tree
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \begin{axis}[
        axis lines = left, xlabel = $R$, ylabel = Probabilidades,
