...
O esquema permite assinar múltiplos \emph{bits} em cada bloco da assinatura,
...
A partir destes, calcula-se
    ...
    t = t_1 + t_2,$$
que representarão, respectivamente e em palavras de tamanho $m$, a quantidade do bloco da assinatura referente à mensagem, à soma de verificação, e o tamanho total.
