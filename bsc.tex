...
\usepackage{amsmath, amsfonts, chronology, enumitem, parskip, tikz, tikz-qtree, xfrac}
...
$$ \lceil \log_2 (t_1 \times 2^w - 1) \rceil \stackrel{?}{\leq} \left\lceil \frac{\lfloor \log_2 t_1 \rfloor + 1 + w}{w} \right\rceil \times w$$

$$ \lceil \log_2 (t_1 \times 2^w - 1) \rceil \stackrel{?}{\leq} \left\lceil \lfloor \log_2 t_1 \rfloor + 1 + w \right\rceil$$

$$ \lceil \log_2 t_1 + \log_2 2^w - 1 \rceil \stackrel{?}{\leq} \left\lceil \lfloor \log_2 t_1 \rfloor + 1 + w \right\rceil$$

$$ \lceil \log_2 t_1 + \log_2 2^w - 1 \rceil \stackrel{?}{\leq} \lfloor \log_2 t_1 \rfloor + 1 + w$$

$$ \lceil \log_2 t_1 + \log_2 2^w - 1 \rceil \stackrel{?}{\leq} \lceil \log_2 (t_1 + 1) \rceil + w$$

$$ \lceil \log_2 t_1 + w \rceil \stackrel{?}{\leq} \lceil \log_2 (t_1 + 1) \rceil + w$$
