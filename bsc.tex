...
\begin{figure}[ht]
    \centering
    \small
      \begin{chronology}[4]{1979}{2018}{90ex}
        \event[1982]{1979}{LD-OTS, WOTS}
        \event{1982}{MSS}
        \event[1996]{1994}{Theoretical results}
        \event[2002]{2001}{BiBa, HORS}
        ...
        \event{2017}{SPHINCS+}
      \end{chronology}
      \caption{Outline of the most important moments in hash-based digital signature schemes research, starting in 1979 with Lamport's one-time scheme, and shortly after with the work of Merkle, allowing many-time schemes through the use of hash trees. The years marked as productive for `'theoretical results`' consist primarily of research about optimal one-time signature schemes and creation of variants.}
\end{figure}
\todo[inline]{paragrafo de conclusao com a timeline dos slides, falando de outros esquemas e mencionando tambem os resultados teoricos \\
https://huelsing.wordpress.com/hash-based-signature-schemes/literature/
modificar e construir uma timeline legal, pontos sem legenda sao resultados nao tao legais \\
(1979) LD-OTS (1979) MSS (1989) WOTS (2001) BiBa (2002) HORS (2006) CMSS(2007) GMSS (2008) SPR-MSS (2011) WOTS-PRF (2011) XMSS (2012) XMSS+(2013) WOTS+ (2013) XMSS-MT (2013-2018) LMS (2013-2018) WOTS-LM (2015) HORST(2015) SPHINCS (2016) WOTS-T (2016) XMSS-T (2017) SPHINCS+}
