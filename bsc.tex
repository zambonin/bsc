...
Matyas-Meyer-Oseas~\cite[9.41]{Menezes:1996:HAC:548089}, apresentada na
Figura~\ref{fig:6}.
...
em~\ref{fig:6}, é definido recursivamente como
\begin{equation}
    \begin{split}
        
    \end{split}
    h_0 = IV, \qquad h_i = E_{g(h_{i-1})}(x_i) \oplus x_i, 1 \leq i \leq t.
\end{equation}
